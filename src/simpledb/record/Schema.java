...
public class Schema {
    ...
    /**
     * Creates an empty schema. Field information can be added to a schema via
     * the five addXXX methods.
     */
    public Schema() {
    }

    /**
     * Adds a field to the schema having a specified name, type, and length. If
    ...
    /**
     * Adds a string field to the schema. The length is the conceptual length of
    ...
    /**
     * Adds a field to the schema having the same type and length as the
    ...
    /**
     * Returns the conceptual length of the specified field. If the field is not
     * a string field, then the return value is undefined.
     *
     * @param fldname the name of the field
